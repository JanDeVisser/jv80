...
QLed::QLed(Shape sh, QWidget *parent) : QWidget(parent), m_shape(sh), renderer() {
}
...
QLedArray::QLedArray(int num, int size, QWidget *parent) : QWidget(parent),
    m_value(0), m_numLeds(num) {
