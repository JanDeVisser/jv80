...
IOChannel::IOChannel(int channelID, std::string &&name, Output &output)
  : ConnectedComponent(channelID, name), m_output(std::move(output)) {
}

IOChannel::IOChannel(int channelID, std::string &&name, Input &&input)
  : ConnectedComponent(channelID, name), m_input(input) {
}

IOChannel::IOChannel(int channelID, std::string &&name, Output &&output)
  : ConnectedComponent(channelID, name), m_output(output) {
}
